...
path_tiltheta = strcat('../../relatorio/figs/ls/tiltheta/',sim_str,file_name,'.eps');
path_modtheta = strcat('../../relatorio/figs/ls/modtheta/',sim_str,file_name,'.eps');
path_epsilon = strcat('../../relatorio/figs/ls/epsilon/',sim_str,file_name,'.eps');
