...
Escolhe-se um polinômio estável $\Lambda(s) =
...
\begin{gather}
\theta* = \left[z_0 \quad z_1 \quad \ldots \quad z_{m-1} \quad z_m \quad
\right. \\
\left. \lambda_0-p_0 \quad \lambda_1-p_1 \quad \ldots \quad
\lambda_{n-2}-p_{n-2} \quad \lambda{n-1}-p_{n-1}\right]^\intercal \in \mathbb{R}^{n+m+1},
\label{eq:parameters}
\end{gather}
