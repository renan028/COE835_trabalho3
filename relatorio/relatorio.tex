...
\lhead{\bfseries{Relatório do Trabalho 3}}%
\chead{}%
...
\begin{center}
  ...
  \Large{Simulações do Trabalho 3} \\[20mm]
\end{center}
...
\textbf{Algoritmo:} \quad \HI{Identificação de parâmetros}\\[2mm]

\bigskip%
Caso: \quad \parbox[t]{10cm}{
  $n = 1, 2, 3$ \quad (ordem da planta) \\[2mm]
  $n^* = 1$ \quad (grau relativo) \\[2mm]
  $n_p = 2, 4, 6$ \quad (\# de parâmetros) \\[15mm]
}
